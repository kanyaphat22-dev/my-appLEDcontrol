                                            ...
                                            child: ElevatedButton(
                                              style: ElevatedButton.styleFrom(
                                                ...
                                                shape: RoundedRectangleBorder(
                                                  ...
                                                  side: BorderSide(color: logoBlue, width: 2),
                                                ),
                                              ...
                                              onPressed: () async {
                                                if (_formKey.currentState!.validate()) {
                                                  ...
                                                  if (result['success'] == true) {
                                                    ...
                                                    if (context.mounted) {
                                                      Navigator.pushReplacementNamed(context, '/floor');
                                                    }
                                                  } else {
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      SnackBar(
                                                        content: Text(result['message'] ?? 'เข้าสู่ระบบล้มเหลว'),
                                                      ),
                                                    );
                                                  }
                                                }
                                          ...
                                          Center(
                                            child: RichText(
                                              text: TextSpan(
                                                ...
                                                style: TextStyle(color: logoBlue, fontSize: 16),
                                                children: [
                                                  TextSpan(
                                                    text: "Register",
                                                    style: TextStyle(
